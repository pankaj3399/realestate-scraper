...
const enTranslations = {
  translation: {
    ...
    "configureFiltersAndScrape": "Configure filters and scrape auction data with advanced search capabilities",
...
const elTranslations = {
  translation: {
    ...
    "configureFiltersAndScrape": "Ρυθμίστε τα φίλτρα και κάντε scrape δεδομένα δημοπρασιών με προηγμένες δυνατότητες αναζήτησης",
    ...
    // Status messages
    "waitBeforeNextScrape": "Παρακαλώ περιμένετε {{timeLeft}} πριν από το επόμενο scrape",
    ...
    "tryAdjustingFilters": "Δοκιμάστε να προσαρμόσετε τα φίλτρα σας για να δείτε περισσότερα αποτελέσματα.",
